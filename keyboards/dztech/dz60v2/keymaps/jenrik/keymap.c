...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        QK_GESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_PSCR, KC_SCRL,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  MO(1),   KC_BSPC,          KC_RALT, KC_RGUI, XXXXXXX, MO(1),   KC_RCTL
    ),
    ...
    LAYOUT(
        ...
        _______, _______, _______, _______, BL_DOWN, BL_TOGG, BL_UP,   BL_STEP, _______, _______, _______, _______, _______, QK_BOOTLOADER,
